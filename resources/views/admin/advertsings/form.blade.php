...
<div class="form-group">
    ...
    <input type="text" name="title" id="title" class="form-control" value="{{ $advertising->title }}">
</div>
...
<div class="input-group">
  ...
  <div class="form-group">
    ...
    <input type="text" name="link" id="link" class="form-control" value="{{ $advertising->link }}">
</div>
